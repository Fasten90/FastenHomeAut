...
void Display_SSD1306_Init(void)
{
	...
	// CS
	GPIO_InitStruct.Pin       = SPIx_CS_GPIO_PIN;
	GPIO_InitStruct.Mode      = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull      = GPIO_PULLUP;
	GPIO_InitStruct.Speed     = GPIO_SPEED_FAST;

	HAL_GPIO_Init(SPIx_CS_GPIO_PORT, &GPIO_InitStruct);
	HAL_GPIO_WritePin(SPIx_CS_GPIO_PORT, SPIx_CS_GPIO_PIN, SET);
	...
	HAL_GPIO_WritePin(DISPLAY_SSD1306_RST_GPIO_PORT, DISPLAY_SSD1306_RST_GPIO_PIN, SET);
...
static void SSD1306_HardwareInit(void)
{
	...
	// Reset --> low --> high
	HAL_GPIO_WritePin(DISPLAY_SSD1306_RST_GPIO_PORT, DISPLAY_SSD1306_RST_GPIO_PIN, RESET);
...
void ssd1306_command(uint8_t c)
{
	...
	HAL_GPIO_WritePin(DISPLAY_SSD1306_DATACOMMAND_GPIO_PORT, DISPLAY_SSD1306_DATACOMMAND_GPIO_PIN, RESET);

	HAL_GPIO_WritePin(SPIx_CS_GPIO_PORT, SPIx_CS_GPIO_PIN, RESET);
...
void SSD1306_display(void)
{
  ...
  ssd1306_command(0); // Page start address (0 = reset)
	...
	// Data
	HAL_GPIO_WritePin(DISPLAY_SSD1306_DATACOMMAND_GPIO_PORT, DISPLAY_SSD1306_DATACOMMAND_GPIO_PIN, SET);
