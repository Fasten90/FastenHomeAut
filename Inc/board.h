...
#define TIMER_PWM_MOTOR_GPIO_CLK_ENABLES()	__GPIOB_CLK_ENABLE()

#define BOARD_PWM_DCMOTOR_PORT				GPIOB
#define BOARD_PWM_DCMOTOR_PIN				GPIO_PIN_8
// RobonAUT - DinamoSaurus 2015 board: PB7, Servo, TIM4-CH2
#define BOARD_PWM_SERVO_PORT				GPIOB
#define BOARD_PWM_SERVO_PIN					GPIO_PIN_7


#define TIMER_PWM_MOTORS_CLK_ENABLES()		__TIM4_CLK_ENABLE();	\
											__TIM10_CLK_ENABLE()
#define TIMx_PWM_DCMOTOR					TIM10
#define TIMx_PWM_SERVO						TIM4

#define TIMER_PWM_DCMOTOR_CHANNEL			TIM_CHANNEL_1
#define TIMER_PWM_SERVO_CHANNEL				TIM_CHANNEL_2

#define TIMx_PWM_DC_GPIO_AF          		GPIO_AF3_TIM10
#define TIMx_PWM_SERVO_GPIO_AF         		GPIO_AF2_TIM4
...
#define MOTOR_DC_DIR1_PORT		GPIOA
#define MOTOR_DC_DIR1_PIN		GPIO_PIN_1

#define MOTOR_DC_DIR2_PORT		GPIOE
#define MOTOR_DC_DIR2_PIN		GPIO_PIN_6
