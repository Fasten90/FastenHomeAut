...
#define BOARD_PWM1_PIN		GPIO_PIN_0
#define BOARD_PWM2_PORT		GPIOB
#define BOARD_PWM2_PIN		GPIO_PIN_1


#define TIMx_PWM1						TIM3
#define TIMx_PWM1_CLK_ENABLE()			__TIM3_CLK_ENABLE()
#define TIMx_PWM2						TIM3
#define TIMx_PWM2_CLK_ENABLE()			__TIM3_CLK_ENABLE()
...
#define TIMER_PWM2_CHANNEL				TIM_CHANNEL_4

#define TIMx_PWM1_GPIO_AF          		GPIO_AF2_TIM3
#define TIMx_PWM2_GPIO_AF         		GPIO_AF2_TIM3
