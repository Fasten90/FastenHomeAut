...
// RobonAUT - DinamoSaurus 2015 board: PB8, Motor control
#define BOARD_PWM1_PORT		GPIOB
#define BOARD_PWM1_PIN		GPIO_PIN_8
// RobonAUT - DinamoSaurus 2015 board: PB7, Servo
#define BOARD_PWM2_PORT		GPIOB
#define BOARD_PWM2_PIN		GPIO_PIN_7


#define TIMx_PWM1						TIM4
#define TIMx_PWM1_CLK_ENABLE()			__TIM4_CLK_ENABLE()
#define TIMx_PWM2						TIM4
#define TIMx_PWM2_CLK_ENABLE()			__TIM4_CLK_ENABLE()

#define TIMER_CLK_ENABLES()				__TIM4_CLK_ENABLE()

#define TIMER_PWM_GPIO_CLK_ENABLES()	__GPIOB_CLK_ENABLE()

#define TIMER_PWM1_CHANNEL				TIM_CHANNEL_3
#define TIMER_PWM2_CHANNEL				TIM_CHANNEL_2

#define TIMx_PWM1_GPIO_AF          		GPIO_AF2_TIM4
#define TIMx_PWM2_GPIO_AF         		GPIO_AF2_TIM4


#define MOTOR_DC_DIRECTIONS_CLK_ENABLES()				\
								__GPIOB_CLK_ENABLE();	\
								__GPIOE_CLK_ENABLE()

#define MOTOR_DC_DIR1_PORT		GPIOB
#define MOTOR_DC_DIR1_PIN		GPIO_PIN_2

#define MOTOR_DC_DIR2_PORT		GPIOE
#define MOTOR_DC_DIR2_PIN		GPIO_PIN_7
